...
\threeheaderrow
{\emph{July 2022--current}}
{\textbf{Freelance Software Developer}}
{\textbf{Anthropic}}
\begin{itemize}[noitemsep, topsep=1pt]
    \item Build open-source dev tooling requested by Anthropic.
    \item Wrote a Flake8 linter plugin for the Trio library in 4 weeks, that's already caught several bugs in deployed code.
\end{itemize}
\vspace{0.5em}
...
\begin{itemize}[noitemsep, topsep=1pt]
    ...
    \item Supported core Linux and Git skills for other team members, writing automation scripts in Pythno \& shell
\end{itemize}
\vspace{0.5em}
\threeheaderrow
{\emph{2013--17}}
