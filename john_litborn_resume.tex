...
\headerrow
    ...
    {120 Credits}
%TODO: rewrite (see Saltroza comments)
...
% - Programming competition winner (2013): sorting algorithm in microcode for a low-level simulated computer. Solution beat the previous student record and professor's record.
\begin{itemize}[noitemsep, topsep=0pt]
